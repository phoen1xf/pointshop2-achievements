ACHIEVEMENT = {}
ACHIEVEMENT.Name = "Pile 'o' Junk" -- The Name of the Achievement. Viewable in the menu.
ACHIEVEMENT.Description = "Collect twenty items in your inventory" -- The description that appears in the menu.
ACHIEVEMENT.Icon = "pileojunk.png" -- The icon that appears in the menu.
ACHIEVEMENT.Min = 0 -- At what stage do you start? Normal starting position is 0.
ACHIEVEMENT.Max = 20 -- At what stage do you earn the achievement? Set to 1 for instant achieve on action completion.
