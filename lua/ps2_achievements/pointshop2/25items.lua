ACHIEVEMENT = {}
ACHIEVEMENT.Name = "Item Whore" -- The Name of the Achievement. Viewable in the menu.
ACHIEVEMENT.Description = "Purchase 25 items" -- The description that appears in the menu.
ACHIEVEMENT.Icon = "25items.png" -- The icon that appears in the menu. Defaults to achievements/iconname.png/vmt
...
ACHIEVEMENT.Initialize = function()
	...
	hook.Add("PS2_PurchasedItem", "Ps2Ach." .. ACHIEVEMENT.Name, function( ply, itemClass )
