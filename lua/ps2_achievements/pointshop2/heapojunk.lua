ACHIEVEMENT = {}
ACHIEVEMENT.Name = "Heap 'o' Junk" -- The Name of the Achievement. Viewable in the menu.
ACHIEVEMENT.Description = "Gather ten items in your inventory" -- The description that appears in the menu.
ACHIEVEMENT.Icon = "heapojunk.png" -- The icon that appears in the menu.
