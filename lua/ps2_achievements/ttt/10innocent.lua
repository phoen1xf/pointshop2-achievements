ACHIEVEMENT = {}
ACHIEVEMENT.Name = "Berate the Innocents" -- The Name of the Achievement. Viewable in the menu.
ACHIEVEMENT.Description = "End 10 innocent lives as a Traitor" -- The description that appears in the menu.
--ACHIEVEMENT.Icon = "10innocent.png" -- The icon that appears in the menu.
