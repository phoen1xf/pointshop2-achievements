ACHIEVEMENT = {}
ACHIEVEMENT.Name = "Tenacious Traitor" -- The Name of the Achievement. Viewable in the menu.
ACHIEVEMENT.Description = "Win the round as a Traitor 25 times" -- The description that appears in the menu.
--ACHIEVEMENT.Icon = "25traitor.png" -- The icon that appears in the menu.
