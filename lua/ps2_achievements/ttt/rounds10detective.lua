ACHIEVEMENT = {}
ACHIEVEMENT.Name = "Dainty Detective" -- The Name of the Achievement. Viewable in the menu.
ACHIEVEMENT.Description = "Win the round as a Detective 10 times" -- The description that appears in the menu.
--ACHIEVEMENT.Icon = "rounds10detective.png" -- The icon that appears in the menu.
