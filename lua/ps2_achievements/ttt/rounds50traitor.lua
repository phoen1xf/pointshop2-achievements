ACHIEVEMENT = {}
ACHIEVEMENT.Name = "Treacherous Traitor" -- The Name of the Achievement. Viewable in the menu.
ACHIEVEMENT.Description = "Win the round as a Traitor 50 times" -- The description that appears in the menu.
--ACHIEVEMENT.Icon = "50traitor.png" -- The icon that appears in the menu.
