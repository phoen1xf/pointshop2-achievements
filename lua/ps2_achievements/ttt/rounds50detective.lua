ACHIEVEMENT = {}
ACHIEVEMENT.Name = "Dashing Detective" -- The Name of the Achievement. Viewable in the menu.
ACHIEVEMENT.Description = "Win the round as a Detective 50 times" -- The description that appears in the menu.
--ACHIEVEMENT.Icon = "rounds50detective.png" -- The icon that appears in the menu.
