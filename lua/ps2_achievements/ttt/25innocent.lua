ACHIEVEMENT = {}
ACHIEVEMENT.Name = "Inoculate the Innocents" -- The Name of the Achievement. Viewable in the menu.
ACHIEVEMENT.Description = "End 25 innocent lives as a Traitor" -- The description that appears in the menu.
--ACHIEVEMENT.Icon = "25innocent.png" -- The icon that appears in the menu.
